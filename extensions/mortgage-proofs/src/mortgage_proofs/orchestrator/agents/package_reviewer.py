...
from mortgage_proofs.orchestrator.tools import PackageReviewOutput
    ...
    response = cast(
        ...
        llm.invoke(
            [
                ...
                HumanMessage(
                    content=PACKAGE_REVIEWER_HUMAN.format(
                        ...
                        special_considerations=", ".join(
                            proposal.special_considerations
                        )
                        or "none",
