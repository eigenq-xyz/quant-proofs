...
from mortgage_proofs.domain.enums import LoanType
from mortgage_proofs.domain.models import MortgagePackageProposal
...
from mortgage_proofs.orchestrator.state import DesignGraphState
from mortgage_proofs.orchestrator.tools import PackageProposalOutput
    ...
    response = cast(
        ...
        llm.invoke(
            [
                ...
                HumanMessage(
                    content=PACKAGE_DESIGNER_HUMAN.format(
