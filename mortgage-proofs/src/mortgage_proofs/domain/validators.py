...
These mirror the formal invariants in lean/MortgageProofs/Invariants.lean.
...
from mortgage_proofs.domain.enums import DocumentType, LoanType, RoutingOutcome
