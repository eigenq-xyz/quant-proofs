...
quintile-spread monotonicity, IC positive in **5 of 5** subperiods, net Sharpe **0.28** in-sample /
...
| 4 | **Combination / incrementality**: overlap + orthogonalized incremental IC | `combination.py` | unverified, rigorous |
...
| — | **Cross-asset generalization** | `crossasset.py` | robustness study |
