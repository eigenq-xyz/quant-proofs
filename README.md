...
| Module | What it proves | Status |
|--------|----------------|--------|
| [`extensions/perpetual-proofs/`](extensions/perpetual-proofs/) | Perpetual-futures no-arbitrage pricing and the inverse-perp convexity correction; builds on `stopped-time-proofs` | **Complete**, 10 theorems, zero `sorry` |
| [`extensions/stopped-time-proofs/`](extensions/stopped-time-proofs/) | Geometric stopping-time expectations and a strict-monotonicity (Jensen) lemma; a mathlib-candidate library (no finance content) | **Complete**, 8 theorems, zero `sorry` |
...
cd ../foundations/ftap-proofs && lake build                                             # a verified foundation
```
