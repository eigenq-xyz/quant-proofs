---
name: conducting-quant-research
description: >
...
- Identify the source hierarchy (see `/sourcing-financial-data`).
...
The formally verified proofs in `ftap-proofs/` and `binomial-proofs/` provide
...
3. Formal guarantees narrow the hypothesis space. If the proof shows that under
   ...
   first (see `/sourcing-financial-data`, QUALITY_NOTES.md).
