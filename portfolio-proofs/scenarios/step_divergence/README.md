...
From the `portfolio-proofs/` directory:
...
This is one of four stress-test scenarios in `portfolio-proofs/scenarios/`. Each
...
See `portfolio-proofs/README.md` for the full problem statement and the
