...
```{python}
#| label: tbl-results
#| tbl-cap: "Summary comparison. Trust-constr and Gurobi report convergence yet return solutions 4.59% worse than the KKT-certified global minimum. OR-Tools PDLP's step size is bounded by 1/λ_max, leading to slow convergence and early termination. SLSQP fails outright."
